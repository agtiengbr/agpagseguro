...
<form action="{$link->getModuleLink('agpagseguro', 'validation', [], true)|escape:'html':'UTF-8'}" method="post" id='agpagseguro_eft_form'>
    {if $error}
    ...
    <div class="box cheque-box">
        ...
        <p>Você pode pagar de maneira prática e segura com débito em conta. Se escolher pagar via boleto, o total de sua compra será de <strong>{displayPrice price=$total_with_discount}</strong>.</p>
